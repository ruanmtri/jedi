class Fase_01 extends Phaser.Scene {
 ...
 //-------------------------------------------------------------------
        ...
        this.quest_0 =  ["Para produzir bolos, uma fábrica utiliza 5 bandejas de ovos por dia.\n Sabendo que em uma bandeja tem 30 ovos,\n quantos ovos serão necessários para produção de bolos no período de 15 dias?",
        3, "◯ 2200", "◯ 193",  "◯ 93",  "◯ 2250"]
        this.quest_1 =  ["A professora de João pediu para ele decompor um número e \nele fez da seguinte forma: 4 x 1000 + 3 x 10 + 5 x 1 \nQual foi o número pedido?   ",
        2, "◯ 4035", "◯ 400",  "◯ 4000",  "◯ 4030"]
        this.quest_2 = ["Se 20 gatos capturam 20 ratos em 20 dias, \nquantos dias levam 5 gatos para capturar 5 ratos?", 
        2, "◯ 15 dias", "◯ 38 dias",  "◯ 49 dias",  "◯ 20 dias"]  
        this.quest_3 = ["Um dia tem 24 horas, 1 hora tem 60 minutos e 1 minuto tem 60 segundos. \nQue fração da hora corresponde a 35 minutos?  ", 
        1, "◯ 9/4", "◯ 7/12",  "◯ 9/14",  "◯ 10/18"]  
        this.quest_4 = ["Num pacote de balas contendo 10 unidades, o peso líquido é de 49 gramas. \nEm 5 pacotes teremos quantos gramas?", 
        1, "◯ 130", "◯ 100",  "◯ 245",  "◯ 250"]  
        this.quest_5 = ["Um fazendeiro tinha 285 bois. Comprou mais 176 bois e depois vendeu 85 deles. \nQuantos bois esse fazendeiro tem agora? ", 
        2, "◯ 380", "◯ 376", "◯ 395", "◯ 300"]
        this.quest_6 = ["Pedro adubou 3/4 de sua horta. A parte da horta adubada por Pedro corresponde a: ", 
        3, "◯ 55%", "◯ 65%", "◯ 60%", "◯ 75%"]
        this.quest_7 = ["O carro de João consome 1 litro de gasolina a cada 10 quilômetros percorridos. \nPara ir da sua casa ao sítio, que fica distante 63 quilômetros, o carro irá consumir: ", 
        2, "◯ 7,3 L.", "◯ 13 L.", "◯ 6,3 L.", "◯ 7 L."]
        this.quest_8 = ["Uma merendeira preparou 558 pães que foram distribuídos igualmente em 18 cestas. \nQuantos pães foram colocados em cada cesta?  ", 
        0, "◯ 31", "◯ 28", "◯ 27", "◯ 33"]
        this.quest_9 = ["Gilda comprou copos descartáveis de 200 mililitros, para servir refrigerantes, em sua festa de aniversário. \nQuantos copos ela encherá com 1 litro de refrigerante?", 
        2, "◯ 9", "◯ 5", "◯ 8", "◯ 10"]
